...
dataframe = pd.read_csv(r'heart-disease-risk-prediction-dataset\heart_disease_risk_dataset_earlymed.csv')
...
torch.save(model.state_dict(), 'heart_disease_classifier_model.pth')